    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        const system = [
          ...
          'Estrutura obrigatória (Markdown simples, use ## para as seções e - para listas):',
          ...
          '## Desenvolvimento da matéria (divida em partes numeradas; explique, exemplifique e compare)',
